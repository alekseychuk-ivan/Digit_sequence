...
class RNNAll(torch.nn.Module):
    # size of dict > our unick numbers                                              default RNN
...
# train and eval our model
def train(NUM_EPOCHS=20, samples_size=1000, test_size=0.2, val_size=0.1, DEVICE=torch.device('cpu')):
...
# create our datasets( train, test, val)
